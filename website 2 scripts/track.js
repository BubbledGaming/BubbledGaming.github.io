...
const tracks = [
    ...
    ["OldAlbumD/169CloudedRealms.ogg",                   "images/old_albumfour_disc.png"],
    ["OldAlbumD/170ForestSunrise.ogg",                   "images/old_albumfour_disc.png"],
    ["OldAlbumD/171LividAgitation.ogg",                  "images/old_albumfour_disc.png"],
    ["OldAlbumD/172BunnyMeadow.ogg",                     "images/old_albumfour_disc.png"],
    ["OldAlbumD/173Frostbyte.ogg",                       "images/old_albumfour_disc.png"],
    ["OldAlbumD/174Abandoned.ogg",                       "images/old_albumfour_disc.png"],
    ["OldAlbumD/175ThePath.ogg",                         "images/old_albumfour_disc.png"],
    ["OldAlbumD/176DrowningInToxicity.ogg",              "images/old_albumfour_disc.png"],
    ["OldAlbumD/177Repetitive.ogg",                      "images/old_albumfour_disc.png"],
    ["OldAlbumD/178GentleStars.ogg",                     "images/old_albumfour_disc.png"],
    ["OldAlbumD/179NightOwlsLullaby.ogg",                "images/old_albumfour_disc.png"],
    ["OldAlbumD/180EmptySpace.ogg",                      "images/old_albumfour_disc.png"],
    ["OldAlbumD/181Equinox.ogg",                         "images/old_albumfour_disc.png"],
    ["OldAlbumD/182CloudWatcher.ogg",                    "images/old_albumfour_disc.png"],
    ["OldAlbumD/183OverclockedRetaliation.ogg",          "images/old_albumfour_disc.png"],
    ["OldAlbumD/184RedroofAwning.ogg",                   "images/old_albumfour_disc.png"],
    ["OldAlbumD/185Duskgrove.ogg",                       "images/old_albumfour_disc.png"],
    ["OldAlbumD/186DropletOfTheSky.ogg",                 "images/old_albumfour_disc.png"],
    ["OldAlbumD/187Outside.ogg",                         "images/old_albumfour_disc.png"],
    ["OldAlbumD/188Hytar.ogg",                           "images/old_albumfour_disc.png"],
    ["OldAlbumD/189Arenas.ogg",                          "images/old_albumfour_disc.png"],
    ["OldAlbumD/190LunarGateway.ogg",                    "images/old_albumfour_disc.png"],
    ["OldAlbumD/191Satellite.ogg",                       "images/old_albumfour_disc.png"],
    ["OldAlbumD/192Resolve.ogg",                         "images/old_albumfour_disc.png"],
    ["OldAlbumD/193Unwanted.ogg",                        "images/old_albumfour_disc.png"],
    ["OldAlbumD/194Ultimatum.ogg",                       "images/old_albumfour_disc.png"],
    ["OldAlbumD/195Downward.ogg",                        "images/old_albumfour_disc.png"],
    ["OldAlbumD/196Worm.ogg",                            "images/old_albumfour_disc.png"],
    ["OldAlbumD/197OutInTheOpen.ogg",                    "images/old_albumfour_disc.png"],
    ["OldAlbumD/198UnderTheWaves.ogg",                   "images/old_albumfour_disc.png"],
    ["OldAlbumD/199Forward.ogg",                         "images/old_albumfour_disc.png"],
    ["OldAlbumD/200Forge.ogg",                           "images/old_albumfour_disc.png"],
    ["OldAlbumD/201OverYonder.ogg",                      "images/old_albumfour_disc.png"],
    ["OldAlbumD/202ItsAQuietTownNow.ogg",                "images/old_albumfour_disc.png"],
    ["OldAlbumD/203Late.ogg",                            "images/old_albumfour_disc.png"],
    ["OldAlbumD/204Kozirium.ogg",                        "images/old_albumfour_disc.png"],
    ["OldAlbumD/205WorldConsumed.ogg",                   "images/old_albumfour_disc.png"],
    ["OldAlbumD/206EndOfTheWorld.ogg",                   "images/old_albumfour_disc.png"],
...
function changeImage() {
    ...
    // Many entries use a relative 'images/...' path. Ensure we point to the website 2 images folder
    if(imageUrl){
        // if the path already looks absolute or already targets the folder, leave it
        if(!/^https?:\/\//.test(imageUrl) && !imageUrl.startsWith('website 2 images/') && !imageUrl.startsWith('/')){
            // strip any leading 'images/' and prefix with the actual folder used in this project
            imageUrl = 'website 2 images/' + imageUrl.replace(/^images\//, '');
        }
    }
